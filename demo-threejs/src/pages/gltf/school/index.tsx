...
const GltfSchool = () => {
  ...
  useEffect(() => {
    if (divRef.current && !viewerRef.current) {
      ...
      viewer.loadWithCamera(
        "/frontend-demos/demo-three/models/school/地面+相机.glb"
      );
      // viewer.load("/frontend-demos/demo-three/models/school/周边建筑.glb");
      viewer.load(
        "/frontend-demos/demo-three/models/school/校内其他建筑.glb",
        true
      );

      [1, 2, 3, 4, 5, 6, 7, 8, 9].forEach((item) => {
        viewer.load(
          `/frontend-demos/demo-three/models/school/${item}.glb`,
          false,
          false,
          (obj: any) => {
            objArr[item - 1] = obj;
      ...
      viewer.load(
        "/frontend-demos/demo-three/models/school/roof.glb",
        false,
        false,
        (obj: any) => {
          objArr[9] = obj;
      ...
      viewer.load(
        "/frontend-demos/demo-three/models/school/浙理工电子围栏.glb"
      );
    }
  }, []);
