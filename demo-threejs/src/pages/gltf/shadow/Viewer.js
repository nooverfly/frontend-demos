...
export class Viewer {
      ...
      loader.load(
        ...
        (gltf) => {
          ...
          scene.traverse(function (child) {
            ...
            //   object.geometry.computeVertexNormals(); // FIX
            // }
            // // if ( object.isMesh || object.isLight ) object.castShadow = true;
            // if (object.isMesh || object.isLight) object.receiveShadow = true;

            if (child.isMesh) {
              debugger;
              child.castShadow = true;
              child.receiveShadow = true;
              // child.material.shading = SmoothShading;
  ...
  addLights() {
    ...
    // light2.position.set(25.5, 15.5, 25.5); // ~60º
    // light2.position.set(25.5, 5, 25.5);
    // light2.target.position.set(0, 0, 10);
    // light2.

    const spotLight = new SpotLight(0xffffff, 3, 200, Math.PI / 4, 0.5, 0.5);
    ...
    // const helper = new DirectionalLightHelper(light2, 5);
    // this.scene.add(helper);
    // window.light = light2;

    // const pl = new PointLight(0xffffff, 4, 1000);
    // pl.position.set(25.987130293611344, 9.079929661396301, -50);
    // this.scene.add(pl);
