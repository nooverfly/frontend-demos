(function (window) {
  ...
  !(function (global) {
    if (!global.AMap)
      throw new Error(
        "请前置引入高德地图 JSAPI ，参见https://lbs.amap.com/api/jsapi-v2/guide/amap-ui/intro"
      );
  })(window);
  var AMapUI;
  !(function () {
        ...
        function newContext(e) {
          ...
          function u(e, t, r) {
            ...
            !hasProp(k, n) || (i && !i.defineEmitComplete)
              ? ((i = s(e)), i.error && "error" === t ? r(i.error) : i.on(t, r))
              : "defined" === t && r(k[n]);
          }
          function c(e, t) {
            ...
            (y = {
              ...
              exports: function (e) {
                if (((e.usingExports = !0), e.map.isDefine))
                  return e.exports
                    ? (k[e.map.id] = e.exports)
                    : (e.exports = k[e.map.id] = {});
              },
              module: function (e) {
                return e.module
                  ? e.module
                  ...
                  u(
                    ...
                    bind(this, function (n) {
                      ...
                      return this.map.unnormalized
                        ...
                        : d
                        ? ((this.map.url = q.nameToUrl(d)), void this.load())
            ...
            (q = {
                ...
                return (
                  ...
                  mixin(o, {
                    ...
                    specified: function (e) {
                      return (
                        (e = a(e, t, !1, !0).id), hasProp(k, e) || hasProp(M, e)
                      );
                    },
                  }),
                  t ||
              ...
              nameToUrl: function (e, t, r) {
                ...
                if (req.jsExtRegExp.test(e)) s = e + (t || "");
                  ...
                  (s = i.join("/")),
                    (s +=
                      t || (/^data\:|^blob\:|\?/.test(s) || r ? "" : ".js")),
                    (s =
                      ("/" === s.charAt(0) || s.match(/^[\w\+\.\-]+:/)
                        ? ""
                        : w.baseUrl) + s);
                }
                return w.urlArgs && !/^blob\:/.test(s)
                  ? s + w.urlArgs(e, s)
                  : s;
              },
              load: function (e, t) {
          ...
          "undefined" == typeof require ||
            ...
            (define = function (e, t, r) {
              ...
              "string" != typeof e && ((r = t), (t = e), (e = null)),
                ...
                i
                  ? (i.defQueue.push([e, t, r]), (i.defQueueMap[e] = !0))
    ...
    AMapUI.define("polyfill/require/require-css/css", [], function () {
      ...
      var e = document.getElementsByTagName("head")[0],
        ...
        n = !0;
      t[1] || t[7]
        ? (r = parseInt(t[1]) < 6 || parseInt(t[7]) <= 9)
        : t[2] || t[8]
        ? (n = !1)
        : t[4] && (r = parseInt(t[4]) < 18);
      var i = {};
      ...
      var o,
        ...
        l = function (e, t) {
          if (((a && a.addImport) || u(), a && a.addImport))
            s ? f.push([e, t]) : (p(e), (s = t));
          else {
        ...
        h = function (t, r) {
          ...
          if (((i.type = "text/css"), (i.rel = "stylesheet"), n))
            i.onload = function () {
      ...
      var n = /([^:])\/+/g,
        ...
        u = function (r, n, i, a) {
          ...
          for (
            ...
            var p = s[5] || s[6] ? 1 : 0;
            (r =
              r.substr(0, c.lastIndex - u.length - p - 1) +
              f +
              r.substr(c.lastIndex - p - 1)),
              (c.lastIndex = c.lastIndex + (f.length - u.length));
          }
          return r;
        };
      return (
        (u.convertURIBase = e), (u.absoluteURI = t), (u.relativeURI = r), u
      );
    }),
    AMapUI.define(
      "polyfill/require/require-text/text",
      ["module"],
      function (e) {
        "use strict";
        function t(e, t) {
        ...
        var n,
          ...
          a,
          s,
          u = ["Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.4.0"],
        ...
        return (
          (n = {
            ...
            parseName: function (e) {
              ...
              return (
                o !== -1 && (!a || o > 1)
                  ? ((t = e.substring(0, o)), (r = e.substring(o + 1)))
                  : (t = e),
                (n = r || t),
                (o = n.indexOf("!")),
                o !== -1 &&
                  ((i = "strip" === n.substring(o + 1)),
                  (n = n.substring(0, o)),
                  r ? (r = n) : (t = n)),
                { moduleName: t, ext: r, strip: i }
              );
            },
            xdRegExp: /^((\w+)\:)?\/\/([^\/\\]+)/,
    ...
    AMapUI.define(
      "polyfill/require/require-json/json",
      ["text"],
      function (text) {
        function cacheBust(e) {
          return (
            (e = e.replace(CACHE_BUST_FLAG, "")),
            (e += e.indexOf("?") < 0 ? "?" : "&"),
            e +
        ...
        var CACHE_BUST_QUERY_PARAM = "bust",
          ...
          jsonParse =
            "undefined" != typeof JSON && "function" == typeof JSON.parse
              ? JSON.parse
              : function (val) {
                  return eval("(" + val + ")");
                },
        ...
        return {
          load: function (e, t, r, n) {
            (n.isBuild &&
              (n.inlineJSON === !1 ||
                e.indexOf(CACHE_BUST_QUERY_PARAM + "=") !== -1)) ||
            0 === t.toUrl(e).indexOf("empty:")
              ? r(null)
              : text.get(
                  t.toUrl(e),
                  function (t) {
          ...
          normalize: function (e, t) {
            return (
              e.indexOf(CACHE_BUST_FLAG) !== -1 && (e = cacheBust(e)), t(e)
            );
          },
  ...
  AMapUI.define("lib/utils", [], function () {
    ...
    utils = {
          ...
          if (source)
            for (var prop in source)
              source.hasOwnProperty(prop) &&
                (utils.isObject(dst[prop]) && utils.isObject(source[prop])
                  ? (dst[prop] = utils.nestExtendObjs({}, [
                      dst[prop],
                      source[prop],
                    ]))
      ...
      isHTMLElement: function (n) {
        return window["HTMLElement"] || window["Element"]
          ? n instanceof (window["HTMLElement"] || window["Element"])
          : n &&
              "object" == typeof n &&
              1 === n.nodeType &&
  ...
  AMapUI.define(
    "lib/$",
    ["lib/detect-global!jQuery,Zepto|" + (AMap.UA.mobile ? "zepto" : "jquery")],
    function ($) {
      return $;
    }
  );
    ...
    var domUtils = {
      ...
      getElementsByClassName: function (className, tag, parent) {
        ...
        for (
          ...
          current = elements[i];
          domUtils.hasClassName(current, className) &&
  ...
  AMapUI.define("lib/event", ["lib/utils"], function (utils) {
    ...
    utils.extend(Event.prototype, {
      ...
      __multiCall: function (ev, listener, func) {
        ...
        utils.isArray(ev)
          ? (evs = ev)
          : "string" == typeof ev && (evs = ev.split(/[\s,]+/));
        if (evs && evs.length > 1) {
  ...
  !(function (ns, window) {
    ...
    0 === reqConf.baseUrl.indexOf("//") &&
      (reqConf.baseUrl = ns.docProtocol + reqConf.baseUrl);
    ...
    ns.version = libConf.version =
      libConf.mainVersion + "." + libConf.patchVersion;
    if (!isDebugMode) {
      reqConf.bundles || (reqConf.bundles = {});
      for (
        var reqBundles = reqConf.bundles, i = 0, len = uiMods.length;
        i < len;
        i++
      ) {
    ...
    reqConf.urlArgs = function (id, url) {
      ...
      if (0 === id.indexOf("ui/")) {
        var parts = id.split("/");
        (3 === parts.length || (4 === parts.length && "main" === parts[3])) &&
          args.push("mt=ui");
    ...
    ns.require = ns.requirejs.config(
      extendObj(
        {
    ...
    ns.weakDefine = function (name) {
      return (
        ("string" != typeof name || !ns.require.defined(name)) &&
        ns.define.apply(ns, arguments)
      );
    };
    ...
    ns.checkDomLibrary = function ($, opts) {
      ...
      return (
        !(
          libInfo.isJQuery &&
          ns.versionCompare(libInfo.version, opts.minJQueryVersion) < 0
        ) ||
        "jQuery当前版本(" +
          libInfo.version +
          ")过低，请更新到 " +
          opts.minJQueryVersion +
          " 或以上版本！"
      );
    };
    ...
    ns.load = function (unames, callback, opts) {
      ns.require(["lib/utils"], function (utils) {
        ...
        for (
          var uname,
            mods = [],
            modNameFilter = opts && opts.modNameFilter,
            i = 0,
            len = unames.length;
          i < len;
          i++
    ...
    ns.loadTpl = function (url, data, cb) {
      ns.require(
        ["lib/underscore-tpl", "text!" + getAbsoluteUrl(url)],
    ...
    isDebugMode ||
      setTimeout(function () {
        ns.loadJs(
          ns.docProtocol +
            "//webapi.amap.com/count?type=UIInit&k=" +
            getAMapKey()
        );
      }, 0);
  })(AMapUI, window);
