...
AMapUI.weakDefine(
  "ui/geo/DistrictExplorer/lib/bbIdxBuilder",
  ["./Const", "./geomUtils"],
  function (Const, geomUtils) {
...
AMapUI.weakDefine(
  "ui/geo/DistrictExplorer/lib/BoundsItem",
  ["lib/utils"],
  function (utils) {
...
AMapUI.weakDefine(
  "ui/geo/DistrictExplorer/ext/topojson-client",
  ["exports"],
  function (exports) {
    "use strict";
...
AMapUI.weakDefine(
  "ui/geo/DistrictExplorer/lib/distDataParser",
  ["./bbIdxBuilder", "./BoundsItem", "../ext/topojson-client"],
...
AMapUI.weakDefine(
  "ui/geo/DistrictExplorer/lib/AreaNode",
  [
    "lib/utils",
    "lib/SphericalMercator",
    "./Const",
    "./geomUtils",
    "./bbIdxBuilder",
  ],
